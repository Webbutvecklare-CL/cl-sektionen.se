...
function Ordbok({ ordbok }) {
    const [sortedOrdbok, setSortedOrdbok] = useState([...ordbok].sort((a, b) => a.begrepp.localeCompare(b.begrepp, "sv")));
    ...
    return (
        <div id="contentbody">
            ...
            <p>Följande är en lista över krångliga begrepp och förkortningar som kan dyka upp på SM eller andra sammanhand på sektionen.</p>
