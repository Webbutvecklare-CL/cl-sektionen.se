    ...
    return(
        <div id="contentbody">
            ...
            <div id="blanketter">
                ...
                <a href="https://docs.google.com/document/d/1R9VzViVigsH3GzNqoHZJUYT3qf6Nw878BST8yCr3Dik"><i className="fa-regular fa-file-pdf"/> Mall för entledigande</a> 
                <a href="https://docs.google.com/document/d/17srFoYElH16ysq_xeu_jlue3W4cxYeJsYgRA2FRWLus"><i className="fa-regular fa-file-pdf"/> Mall för motion</a> 
                <a href="https://docs.google.com/document/d/1-LNWlpYvrYVFwJ9H9fZZO4-a9XAB8KLULQGBnuCX8pQ"><i className="fa-regular fa-file-pdf"/> Mall för äskan</a> 
                <a href="https://docs.google.com/document/d/1iKTCjjld17XxJUKBo9cWCmr1A_vmsATD"><i className="fa-regular fa-file-pdf"/> CL:s SM-ord</a> 
            </div>
            <h2>Styrdokument</h2>
