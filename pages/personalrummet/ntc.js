	...
	return (
		<div id="contentbody">
			<article>
				...
				<p>
					Här testar vi notiser. Om du vill vara med och testa kan du välja
					vilken kategori du vill få notiser ifrån, du kan välja båda. Om du är
					osäker på om din enhet stödjer notiser tryck på &quot;Kolla
					support&quot;.
				...
				<div className={styles.subscriptionMenu}>
					...
					<button type="button" onClick={testSupport}>
						Kolla support
					</button>
