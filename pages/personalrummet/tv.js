      ...
      {userData && (
        <div>
          ...
          <p>
            ...
            av bilden bestäms av den mest dominanta färgen i bilden.
          </p>
          <p>
            Du ska ange ett datum för till och med dagen bilden ska tas ner, inte mer än 7 dagar.
            Bilderna tas bort manuellt vilket kan innebär att de är kvar någon dag längre än datumet
            du angett. Om det är extra viktigt bilden tas ner exakt ett datum ska du kontakta{" "}
