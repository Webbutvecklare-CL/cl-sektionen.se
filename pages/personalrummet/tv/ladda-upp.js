		...
		<div id="contentbody">
			...
			{userData && (
				<div>
					...
					<p>
						När du laddar upp en bild tänk på att göra texten stor. Bakgrunden
						på TVn som inte täcks av bilden bestäms av den mest dominanta färgen
						i bilden. Du kan se detta i förhandsvisningen.
					</p>
					<p>
						Bilden kommer att visas på TVn från och med det datum du anger.
						Bilden kommer att sluta visas automatiskt efter slutdatumet du
						angivit. Du kan ändra datumen senare på hantera sidan.
					</p>
