    ...
    return (
        <div id="contentbody">
            ...
            <div className="tabs-wrapper">
                <button onClick={() => {setCalendar(0)}} className={`kal-knapp sektionskalender ${(activeIdx === 0)? "active" : ""}`}>Sektionskalender</button>
                <button onClick={() => {setCalendar(1)}} className={`kal-knapp gråttkalender ${(activeIdx === 1)? "active" : ""}`}>Gråttans kalender</button>
            </div>
            
            <div id="sektionskal" className="kalender_tab" style={{display: activeIdx === 0? "block":"none"}}>
            ...
            <div id="gråttkal" className="kalender_tab" style={{display: activeIdx === 1? "block":"none"}}>
