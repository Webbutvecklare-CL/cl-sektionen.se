							...
							<div className={styles.feedWrapper}>
								<div className={styles.feedColumn}>
									...
									<Link className={styles.sectionButton} href={"/aktuellt"}>
										<button
											type="button"
											aria-label="Fler informationsinlägg"
											className="small hollow dark"
										>
											Fler inlägg
										</button>
									</Link>
								...
								<div className={styles.feedColumn}>
									...
									<Link
										...
										href={"/aktuellt?info=false"}
									>
										<button
											type="button"
											aria-label="Fler eventinlägg"
											className="small hollow dark"
										>
											Fler event
										</button>
...
export async function getStaticProps() {
	...
	const newestEventDate = eventList.length
		? new Date(eventList[0].publishDate.seconds * 1000)
		: 0;
	const newestInfoDate = infoList.length
		? new Date(infoList[0].publishDate.seconds * 1000)
		: 0;
