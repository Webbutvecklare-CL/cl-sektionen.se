      ...
      <div id="contentbody" className="index_content">
        ...
        <div className={`om-container ${open ? "open" : "collapsed"}`}>
          ...
          <section className="om">
            <section>
              <h2>Om sektionen</h2>
              <p>
                <b>Sektionen</b> för Civilingenjör & Lärare (CL) är en ideell studentsektion under
                Tekniska Högskolans Studentkår och företräder studenter på KTH inom programmet
                Civilingenjör och lärare samt två utbildningar med kompletterande pedagogisk
                utbildning för den som redan har ämneskunskaper.
              </p>
              <p>
            ...
            <section>
              <h2>Om programmet</h2>
              <p>
                <b>Programmet</b> Civilingenjör och lärare 300 hp (CLGYM) är ett program som sedan
                2002 erbjuds på KTH. Utbildningen leder till dubbla yrkesexamina: en fullständig
                civilingenjörsexamen samt en komplett lärarutbildning med behörighet för
                undervisning i gymnasieskolan och högstadiet.
              </p>
              <p>
                Det finns fyra inriktningar på programmet. De olika inriktningarna samläser med
                motsvarande civilingenjörsutbildning och ger behörighet för undervisning i olika
        ...
        <section className="resurser">
          <div>
            ...
            <p>
              Det finns stöd för dig som du blir utsatt för diskriminering, trakasserier eller annan
              illabehandling av en annan student, en lärare eller övrig personal på KTH. Sektionens
              skyddsombud har tystnadsplikt och kan hjälpa dig om något inträffat. Du kan också
              alltid vända dig till JML-nämndens ordförande eller Ledamot för studiesociala- och
              JML-frågor i sektionsstyrelsen. Då får du stöd och hjälp att anmäla incidenten till
              KTH eller annan relevant instans.
            </p>
            <p>
              Du kan både anmäla sådant som du själv utsatts för och sådant som andra utsatts för
              och du kan självklart välja att vara anonym. Ingen incident är för liten, utan det är
              jätteviktigt att allt lyfts så att det kan åtgärdas!
            </p>
            <p>
              Följande länk leder till ett formulär där anmälan om illabehandling kan göras till
