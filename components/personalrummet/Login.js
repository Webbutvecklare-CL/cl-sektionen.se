		...
		<div>
			...
			{screen === "signup" && (
				<div>
					...
					<p>
						(1) Klicka på &#34;Lägg till konto&#34; och logga in igen för att
						lägga till din mail i systemet.
						<br />
						(2) Meddela därefter någon av de webbansvariga att du vill ha
						behörighet till personalrummet.
					</p>
			...
			{screen === "no permission" && (
				<div>
					<h3>
						Du är registrerad men du saknar behörighet till personalrummet.
					</h3>
					<p>Be eller invänta att webbansvariga uppdatera din behörighet.</p>
					<p>
						När du har fått bekräftat att du är inlagd och fått rätt behörighet
						kan du testa att logga in igen.
					</p>
					<button type="button" onClick={handleLogin}>
						Logga in
					</button>
